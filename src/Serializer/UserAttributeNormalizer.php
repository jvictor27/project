...
class UserAttributeNormalizer implements ContextAwareNormalizerInterface, SerializerAwareInterface
{
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        // Continuando com a serialização
    ...
    private function passOn($object, $format, $context)
    {
        if(!$this->serializer instanceof NormalizerInterface) {
            throw new \LogicException(sprintf('Não é possível normalizar objetto "%s" porque o serializador injetado não é um normalizaador.', $object));
        }
